...
include 'db_con.php';
    $output='';
    $sql = "SELECT * FROM package where school = '".$_POST["school"]."' AND faculty = '".$_POST["faculty"]."' AND department = '".$_POST["department"]."'  AND Program = '".$_POST["Program"]."' AND semester = '".$_POST["semester"]."' AND level = '".$_POST["level"]."'";
             ...
             <p style="float:left">'.$row['Program'].'</p>
              ...
              <p style="text-align:center">'.$row['level'].'</p>
                ...
                <div class="col-sm-12 col-xs-12 book-options pdg-l-r-0">
                    ...
                    <div class="col-sm-6 col-xs-6">
                        <button id="btn-downloadbook" style="font-size:10px;" book="'.$row['upload'].'" price="'.$row['price'].'"  email="'.$_SESSION['email'].'" class="form-control btn-smartshelf btn-dark text-center">DOWNLOAD</button>
                    </div>
                    <br><br><br>
