...
include 'db_con.php';
    $output='';
    $sql = "SELECT * FROM course_material where id = '".$_POST["id"]."'";
            ...
            <div class="col-sm-12 col-xs-12 book-info mrg-tp-65 pdg-l-r-0">
               ...
               <p>'.$row['Program'].'</p>
                ...
                <div class="col-sm-12 col-xs-12 book-options pdg-l-r-0">
                    ...
                    <div class="col-sm-6 col-xs-6">
                        <button id="btn-downloadbook" book="../dashboard/'.$row['course_material'].'" price="'.$row['price'].'" email="'.$_SESSION['email'].'" class="form-control btn-smartshelf btn-dark text-center">DOWNLOAD</button>
