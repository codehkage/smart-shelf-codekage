...
<body>
    <div class="search-wrapper">
        ...
        <div class="col-sm-7 col-xs-7 pdg-l-r-0">
            <input type="text" class="form-control smartshelf-input" id="search-book" placeholder="Search...">
        </div>
        <div class="col-sm-3 col-xs-3 pdg-r-0">
            <div class="form-group">
                <select class="smartshelf-input search-options" id="serc" style="border-bottom:none;width: 82px;padding: 0px;">
