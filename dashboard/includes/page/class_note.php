...
$sql = "SELECT * FROM class_note";
 ...
 echo"<td>".$row['classnote_title']."</td>";
 echo"<td>".$row['classnote_code']."</td>";
 ...
 echo"<td><button table='class_note' id='".$row['id']."' class='edit'>Edit</button></td>";
 echo"<td><button table='class_note' id='".$row['id']."' class='delete'>Delete</button></td>";
 echo"</tr>";
    }
