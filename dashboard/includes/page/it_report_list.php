...
$sql = "SELECT * FROM it_report";
 ...
 echo"<td><button table='it_report' id='".$row['id']."' class='edit'>Edit</button></td>";
 echo"<td><button table='it_report' id='".$row['id']."' class='delete'>Delete</button></td>";
 echo"</tr>";
    }
