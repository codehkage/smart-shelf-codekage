...
<div id="page-wrapper">
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Add a Project Work</h4>
              </div>
            ...
            <form method="post" action="upload-project_work.php" enctype="multipart/form-data">
                ...
                <div class="row" style="WIDTH:100%;MARGIN: 10PX AUTO;">
                    <div class="col-sm-6">
                            <div class="form-group">
                        <label>Price</label>
                        <input type="text" name="price" id="fileToUpload" class="form-control">
                            </div>
                    </div>
                    <div class="col-sm-6">
                            <div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Project Work</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            SmartShelf Project Work
                            <button type="button" style="float:right; margin:-5px auto;" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal">Project Work</button>
                        </div>
                        <div class="row" style="WIDTH:100%;MARGIN: 10PX AUTO;">
                        <div class="col-sm-6">
    ...
    $(document).ready(function(){
        setInterval(function(){
            $('#project_work').load('includes/page/project_work.php');
        });
    });
    $(document).ready(function() {
