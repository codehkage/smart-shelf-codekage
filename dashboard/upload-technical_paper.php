...
$links1 = $target_file1;
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    ...
    $description = mysqli_real_escape_string($connect, $_POST['description']);
            ...
            if ($status=="OK") {
                 print"<script> alert('I am Working'); </script>";
            $insertme = mysqli_query($connect, "INSERT INTO text_book(school_name,books_title,author,price,description,Cover_Pics,text_book) VALUES ('$school_name','$books_title','$author','$price','$description','$links','$links1')");
            if ($insertme) {
