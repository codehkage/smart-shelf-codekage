...
<div id="page-wrapper">
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Add a Course Material</h4>
              </div>
            ...
            <form method="post" action="upload-courses-material.php" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Course Material</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            SmartShelf Courses Materials
                            <button type="button" style="float:right; margin:-5px auto;" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal">Add an Courses Materials</button>
                        </div>
    ...
    $(document).ready(function() {   
        setInterval(function(){
            $('#course_material').load('includes/page/course_material.php');
        }, 1000);
         setInterval(function(){
            $('#course_material2').load('includes/page/course_material2.php');
        }, 1000);
    });
