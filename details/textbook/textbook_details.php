...
session_start();
    $output='';
    $sql = "SELECT * FROM text_book where id = '".$_POST["id"]."'";
            ...
            <div class="col-sm-12 col-xs-12 book-info mrg-tp-65 pdg-l-r-0">
               ...
               <p>'.$row['author'].'</p>
                ...
                <div class="col-sm-12 col-xs-12 book-options pdg-l-r-0">
                    ...
                    <div class="col-sm-6 col-xs-6">
                        <button id="btn-downloadbook" book="'.$row['text_book'].'" price="'.$row['price'].'" email="'.$_SESSION['email'].'" class="form-control btn-smartshelf btn-dark text-center">DOWNLOAD</button>
                    </div>
...
<!-- <div class="row">
        ...
        <object data="dashboard/'.$row['Preview'].'">
          <iframe src="dashboard/'.$row['Preview'].'" width="100%" height="400px">
            ...
            <a href="dashboard/'.$row['text_book'].'" download rel="external"><button class="btn btn-primary" style="float:right">Download</button></a>
            </div>
            <div>
            </div> -->