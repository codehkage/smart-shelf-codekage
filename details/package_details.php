...
<body id="home-page">
	<div class="wrapper">
		<nav id="sidebar">
			...
			<div class="sidebar-body">
				<ul class="list-unstyled components">					
					...
					<li><span class="pull-left sidebar-links-icon"><i class="fa fa-snapchat"></i></span><a href="#" style="margin-left: 30px;" rel="external">Smart Active</a></li>
		...
		<div id="content">
			...
			<div class="overlay">
			<?php include 'undergraduate/package_details.php'; ?>
