            ...
            <div class="col-sm-12 col-xs-12 book-info mrg-tp-65 pdg-l-r-0">
                ...
                <div class="col-sm-12 col-xs-12 book-options pdg-l-r-0">
                    ...
                    <div class="col-sm-6 col-xs-6">
                        <button id="btn-downloadbook" price="'.$row['price'].'"  email="'.$_SESSION['email'].'" class="form-control btn-smartshelf btn-dark text-center">DOWNLOAD</button>
                    </div>

                <div class="col-sm-12 col-xs-12 book-description-wrapper">
                    <p class="book-description">
                        <strong>DESCRIPTION</strong><br>
                        '.$row['description'].'<a href=""> Read More</a>
                    </p>
                </div>
